...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_full_update(self):
        ...
        payload = {
            ...
            'description':'New recipe descriptiopn',
            'time_minutes': 10,
            'price': Decimal('2.50')
    ...
    def test_other_user_recipe_error(self):
        """Test trying to delete another users gives an error."""
        new_user = create_user(email='user2@example.com',password='test123')
...
class ImageUploadTests(TestCase):
    ...
    def tearDown(self):
        ...
        #after the tests is executed if we uploaded any image to that recipe, will be deleted.
        # we don't want to store images in our machine. we want to delete after it has finished execeuting the test
